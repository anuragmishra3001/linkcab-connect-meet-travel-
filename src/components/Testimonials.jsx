  ...
  const testimonials = [
    {
      ...
      avatar: "👩‍💼",
      rating: 5,
      text: "LinkCab has completely transformed my daily commute! I've saved over $200 this month and met some amazing people. The app is so easy to use and the drivers are always punctual.",
