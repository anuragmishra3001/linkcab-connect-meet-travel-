      ...
      line_items: [
        {
          price_data: {
            ...
            unit_amount: Math.round(ride.pricePerSeat * 100), // Stripe uses cents
          },
          quantity: seats,
        },
      ],
  ...
  try {
    ...
    res.json({
      ...
      data: {
        ...
        totalPaid: session.amount_total / 100, // Convert from cents to dollars
      ...
      line_items: [
        {
          price_data: {
            ...
            unit_amount: Math.round(planFeatures.price * 100), // Stripe uses cents
          },
          quantity: 1,
        },
      ],
